...
class MrssFeed
  ...
  def self.all
    [
      self.new('http://www.herschel.caltech.edu/rss/images.xml'),
      self.new('http://spitzer.caltech.edu/resource_list/0?format=xml'),
      self.new('http://wise.ssl.berkeley.edu/iotwrss.xml')
    ]
  end
